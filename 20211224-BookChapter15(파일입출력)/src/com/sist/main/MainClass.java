 ...
 *                                                 
 *     파일에 대한 정보 : File
 *     보조스트림 → InputStreamReader / 바이트 → 문자로 변경
 *     
 ...
 *     보조 스트림 
 *     BufferedReader 
 *      1) 파일 : 전체 메모리에 저장 후 응용프로그램 
 *      2) 응용프로그렘 : 전체를 모아서 하드디스크
 *     → readLine() , close()
 *     ==========================================================
 *     파일에 정보 : File (파일,디렉토리)
 *     1. 파일 정보 
...
public class MainClass {
	...
	public static void main(String[] args) {
        ...
        {
        	// 읽을 파일 설정 
        	FileInputStream fis=new FileInputStream("C:\\Users\\user\\Desktop\\자료\\2021-12-13.zip");
        	// 저장 파일 설정 
        	FileOutputStream fos=new FileOutputStream("c:\\java_data\\2021-12-13.zip");
        	int i=0; // 읽은 바이트 수 
