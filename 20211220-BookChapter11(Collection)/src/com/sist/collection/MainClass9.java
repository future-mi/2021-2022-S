...
// Set : HashSet → 데이터를 출력할 때 Iterator이용, toString()
import java.util.*;
public class MainClass9 {
	public static void main(String[] args) {
		// 1. 저장공간, 중복된 데이터(ArrayList), 중복없는데이터(HashSet)
		...
		set.add("바나나");	// 중복일 경우에는 추가하지 않음
		System.out.println("과일종류: "+set.size());
		System.out.println(set.toString());
